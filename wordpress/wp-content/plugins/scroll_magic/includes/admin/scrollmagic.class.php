	...
	class BestBug_ScrollMagic_Builder {
		...
		public function adminEnqueueScriptsAddScene() {
			if(isset($_GET['page']) && $_GET['page'] == BESTBUG_SCENE_ADD) {
				...
				wp_enqueue_script( 'addIndicators', BESTBUG_SM_URL . 'assets/libs/scrollmagic/plugins/debug.addIndicators.min.js', array( 'jquery' ), '2.0.6', true );
		...
		public function remove_all(){
			...
			<div class="remove_all">
				<button class="button danger delete_checked_ids"><span class="dashicons dashicons-trash"></span><?php esc_html_e('Delete checked', 'bestbug') ?></button>	
