...
defined( 'BESTBUG_CORE_VERSION' ) or define('BESTBUG_CORE_VERSION', '1.3.1') ;
...
if ( ! class_exists( 'BestBug_Core_Class' ) ) {
	...
	class BestBug_Core_Class {
		...
		public static function adminEnqueueScripts() {
			...
			wp_enqueue_script( 'bb-core', BESTBUG_CORE_URL . '/assets/js/script.js', array( 'jquery', 'wp-color-picker' ), BESTBUG_CORE_VERSION, true );
		}
