	...
	$(document).ready(function(){
		...
		if($('.bb-multi-select').length > 0) {
			$('.bb-multi-select').multiSelect({
				selectableScrollmagic: "<span class='dashicons dashicons-search'></span><input type='text' class='bb-filter-input' autocomplete='off' placeholder='Selectable items..'>",
				selectionScrollmagic: "<span class='dashicons dashicons-search'></span><input type='text' class='bb-filter-input' autocomplete='off' placeholder='Selection items..'>",
